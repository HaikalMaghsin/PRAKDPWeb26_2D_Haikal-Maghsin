...
1. **Tambah breakpoint baru** — misalnya `@media (min-width: 1400px)`
   ...
   (dari [dokumentasi jobsheet-02](https://github.com/dimas1984/PemogramanWeb2026/blob/2db73f56ff348f4ed0502ea2f8aedd710fb38420/kode-praktikum/jobsheet-02/Dokumentasi/05-css-main-dan-section.md#52-membatasi-lebar--menengahkan-konten-main))
